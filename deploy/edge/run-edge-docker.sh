...
EDGE_DATAPLANE_MTLS="${EDGE_DATAPLANE_MTLS:-false}" # present a CP-issued mTLS client cert to the core (needs EDGE_UPSTREAM_TLS=true + the core's :443)
...
args=(
  ...
  -e EDGE_DATAPLANE_MTLS="$EDGE_DATAPLANE_MTLS"
